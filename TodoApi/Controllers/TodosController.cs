...
public class TodosController : ControllerBase
{
    ...
    public async Task<ActionResult<List<TodoModel>>> Get()
    {
        ...
        {
            _logger.LogError(ex, "The GET call to the api/Todos failed.");
            return BadRequest();
        }
    }
    ...
    public async Task<ActionResult<TodoModel>> Post([FromBody] string task)
    {
        ...
        {
            _logger.LogError(ex, "The POST call to the api/Todos failed. The task value was: {task}", task);
            return BadRequest();
        }
    }
    ...
    public async Task<ActionResult> Put(int todoId, [FromBody] string task)
    {
        ...
        {
            _logger.LogError(ex, "The PUT call to the {ApiPath} failed. The ID was {TodoId}",
                $"api/Todos/Id",
                todoId);
            return BadRequest();
        }
    ...
    public async Task<IActionResult> Complete(int todoId)
    {
        ...
        {
            _logger.LogError(ex, "The PUT call to the api/Todos/{TodoId}/Complete failed.",
               todoId);
            return BadRequest();
        }
    }
    ...
    public async Task<IActionResult> Delete(int todoId)
    {
        ...
        {
            _logger.LogError(ex, "The DELETE call to the api/Todos/{TodoId} failed.",
               todoId);
            return BadRequest();
        }
    }
